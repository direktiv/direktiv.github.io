...
Direktiv offers a gateway, providing access to internal resources via custom [routes](routes.md). The gateway primarily serves to modify or enrich incoming requests and implement authentication. 
