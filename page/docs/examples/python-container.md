...
This special command enables the user to pass in files as well. This can be done with the standard files in Direktiv's filesystem or on-demand like in this example. The file `script.py` is getting created when the function 
